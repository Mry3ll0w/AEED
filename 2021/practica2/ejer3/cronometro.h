...
// Notas:
//
// La funci�n clock() devuelve el tiempo en unas unidades llamadas
// �pulsos�. Para convertir el tiempo a segundos es necesario dividir
// por el n�mero de pulsos por segundo. Esta cantidad aparece definida
// en la macro CLOCKS_PER_SEC cuyo tipo puede ser entero o de coma
// flotante y que mantenemos en pps, que es de tipo double. Si
// queremos hacer expl�cita una posible conversi�n de CLOCKS_PER_SEC a
